...
You'll be asked for different nouns and verb, try to keep the  funny""")

pluaralnoun = raw_input("please provide a plural noun:")
...
print(madlibs %(pluaralnoun,noun1,noun2,song,verb))